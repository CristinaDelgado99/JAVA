...
public class HorarioDawColores {
	public static void main(String[] args) {
		...
		System.out.println(" --------------------------------------------------------------------------------");
		System.out.printf(
				"| %-12s |" + rojo + " %-10s" + blanco + " |" + rojo + " %-10s" + blanco + " |" + rojo + " %-10s"
						+ blanco + " |" + rojo + " %-10s " + blanco + "|" + rojo + " %-10s " + blanco + "|\n",
				" ", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes");
		System.out.println(" --------------------------------------------------------------------------------");
		System.out.printf("|" + rojo + " %-12s " + blanco + "|" + morado + " %-10s " + blanco + "|" + negro + " %-10s "
				+ blanco + "|" + negro + " %-10s " + blanco + "|" + amarillo + " %-10s " + blanco + "|" + azul
		...
		System.out.println(" --------------------------------------------------------------------------------");
		System.out.printf("|" + rojo + " %-12s " + blanco + "|" + morado + " %-10s " + blanco + "|" + cian + " %-10s "
				+ blanco + "|" + negro + " %-10s " + blanco + "|" + cian + " %-10s " + blanco + "|" + cian + " %-10s "
				+ blanco + "|\n", "17:15-18:15", "FOL", "PROG", "BBDD", "PROG", "PROG");
		System.out.println(" --------------------------------------------------------------------------------");
		System.out.printf("|" + rojo + " %-12s " + blanco + "| %-10s   %-10s   %-10s   %-10s   %-10s " + blanco + "|\n",
				"18:15-18:30", " ", " ", "RECREO", " ", " ");
		System.out.println(" --------------------------------------------------------------------------------");
		System.out.printf("|" + rojo + " %-12s " + blanco + "|" + verde + " %-10s " + blanco + "|" + cian + " %-10s "
				+ blanco + "|" + negro + " %-10s " + blanco + "|" + cian + " %-10s " + blanco + "|" + cian + " %-10s "
				+ blanco + "|\n", "18:30-19:25", "EEDD", "PROG", "BBDD", "PROG", "PROG");
		System.out.println(" --------------------------------------------------------------------------------");
		System.out.printf("|" + rojo + " %-12s " + blanco + "|" + amarillo + " %-10s " + blanco + "| " + azul + "%-10s "
				+ blanco + "|" + verde + " %-10s " + blanco + "|" + cian + " %-10s " + blanco + "|" + amarillo

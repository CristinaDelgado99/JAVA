...
public class EscenaCaracteresColores {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				" " + rojo + "  /" + azul + " o " + rojo + "\\    " + cian + "          ***                      * ");
		System.out.println(" " + rojo + " /" + amarillo + "-----" + rojo + "\\  " + cian
				+ "                  **               ***");
		System.out.println(" " + amarillo + " |" + negro + "#" + rojo + " [] " + amarillo + "|  " + cian
				+ "                 **** ");
		System.out
				.println(verde + "----------------------------------" + negro + "|\\" + verde + "--------------------");
		System.out.println("   " + blanco + " * " + rojo + " *          " + negro + "  |\\ " + amarillo + " ___   "
				+ negro + "   @   " + amarilloOscuro + "    °" + verde);
		System.out.println("     \\/ " + amarilloOscuro + " °  " + negro + "       @  " + amarillo + " (" + blanco + "^"
				+ rojo + "o" + blanco + "^" + amarillo + ")            " + morado + "   * " + azul + " *");
		System.out.println("          " + amarilloOscuro + "    °   " + morado + "   --" + amarillo + "/" + rojo + "|_|"
				+ amarillo + "\\" + morado + "--   " + amarilloOscuro + "     ° " + verde + "    \\/");
		System.out.println(
				"     " + rojo + "    * " + morado + " *       /  " + azul + " / \\ " + morado + "  \\" + verde);
		System.out.println("          \\/   " + morado + "    /           \\     " + blanco + "  * " + amarilloOscuro
				+ " *" + morado);
